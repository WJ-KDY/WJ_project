...
HD_PWD='C:/Users/oem/Desktop/VXONE_V01_4K_144/VXONE_V01.runs/CPU_block_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_block_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_block_xbar_0.tcl
