...
-- Date        : Tue Oct 31 09:16:52 2023
-- Host        : DESKTOP-T0RQS2O running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/oem/Desktop/VXONE_V01_4K_144/VXONE_V01.gen/sources_1/bd/CPU_block/ip/CPU_block_clk_wiz_1_1/CPU_block_clk_wiz_1_1_sim_netlist.vhdl
...
entity CPU_block_clk_wiz_1_1_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end CPU_block_clk_wiz_1_1_clk_wiz;

architecture STRUCTURE of CPU_block_clk_wiz_1_1_clk_wiz is
  signal clk_out1_CPU_block_clk_wiz_1_1 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity CPU_block_clk_wiz_1_1 is
  port (
    clk_out1 : out STD_LOGIC;
    locked : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  ...
  attribute NotValidForBitStream of CPU_block_clk_wiz_1_1 : entity is true;
end CPU_block_clk_wiz_1_1;

architecture STRUCTURE of CPU_block_clk_wiz_1_1 is
begin
inst: entity work.CPU_block_clk_wiz_1_1_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked
