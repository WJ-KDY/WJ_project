...
HD_PWD='C:/Users/oem/Desktop/VXONE_V01_4K_120/VXONE_V01.runs/CPU_block_dlmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_block_dlmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_block_dlmb_bram_if_cntlr_1.tcl
